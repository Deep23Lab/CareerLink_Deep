                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="404.jsp" class="dropdown-item">Job Category</a>
                        </div>
                    </div>
                    <a href="register.jsp" class="nav-item nav-link">Register</a>
                </div>
                <a href="add_job.jsp" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Post A Job<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
